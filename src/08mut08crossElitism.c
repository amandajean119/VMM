...
int main(){
	...
	remove("fitness08mut08crossElitism.txt");
	remove("chromosome08mut08crossElitism.txt");
	
	fitnessFile = fopen("fitness08mut08crossElitism.txt", "w");
	chromosomeFile = fopen("chromosome08mut08crossElitism.txt", "w");
