...
int main(){
	...
	remove("fitness0mut08crossElitism.txt");
	remove("chromosome0mut08crossElitism.txt");
	
	fitnessFile = fopen("fitness0mut08crossElitism.txt", "w");
	chromosomeFile = fopen("chromosome0mut08crossElitism.txt", "w");
