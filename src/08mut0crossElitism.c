...
int main(){
	...
	remove("fitness08mut0crossElitism.txt");
	remove("chromosome08mut0crossElitism.txt");
	
	fitnessFile = fopen("fitness08mut0crossElitism.txt", "w");
	chromosomeFile = fopen("chromosome08mut0crossElitism.txt", "w");
