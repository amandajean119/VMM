...
int main(){
	...
	remove("fitness0mut08crossnoElitism.txt");
	remove("chromosome0mut08crossnoElitism.txt");
	
	fitnessFile = fopen("fitness0mut08crossnoElitism.txt", "w");
	chromosomeFile = fopen("chromosome0mut08crossnoElitism.txt", "w");
