...
int main(){
	...
	remove("fitness08mut08crossnoElitism.txt");
	remove("chromosome08mut08crossnoElitism.txt");
	
	fitnessFile = fopen("fitness08mut08crossnoElitism.txt", "w");
	chromosomeFile = fopen("chromosome08mut08crossnoElitism.txt", "w");
